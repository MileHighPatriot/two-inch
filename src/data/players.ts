...
export const players: Player[] = [
  ...
  p('Trevor Lawrence', 'QB', 'JAX', 92, 3, 'R10–R12', [], 'Wait window. Fine if Maye/Daniels/Hurts/Burrow/Dak/Herbert are gone. One QB only.'),
  p('Caleb Williams', 'QB', 'CHI', 80, 4, 'Streamer', [], 'Streamer price in 4-pt 1QB. Do not take him before the Maye group.'),
  p('Matthew Stafford', 'QB', 'LAR', 86, 4, 'Streamer', [], 'Week 11 bye with Puka/Kyren. Streamer only after the wait list is gone.'),
  p('Patrick Mahomes', 'QB', 'KC', 100, 4, 'Streamer', [], 'Name brand, late ADP in this scoring. Only if the wait group is gone. One QB.'),
  p('Brock Purdy', 'QB', 'SF', 101, 4, 'Streamer', [], 'Australia Week 1 with CMC/Kittle. Streamer, not a reach in round 8.'),
  ...
  // RB Tier 5
  p('Cam Skattebo', 'RB', 'NYG', 41, 5, 'R5–R7', [], 'Committee/rookie flavor at RB depth. Fine as a third back after two three-down names, not as RB2.'),
  p('Quinshon Judkins', 'RB', 'CLE', 45, 5, 'R5–R7', [], 'Week 11 nuke group.'),
  p('D\'Andre Swift', 'RB', 'CHI', 47, 5, 'R5–R7', [], 'Bears lead-ish but not a locked three-down back. Depth after the RB pair. Late script backup to Waddle.'),
  p('Bucky Irving', 'RB', 'TB', 53, 5, 'R5–R7', [], 'Late script: Irving is RB2 if the turn failed and you have one RB.'),
  p('Bhayshul Tuten', 'RB', 'JAX', 56, 5, 'R5–R7', [], 'Jaguars committee dart. Early script backup at R7. Not a Robust-RB brick.'),
  p('Jadarian Price', 'RB', 'SEA', 60, 5, 'R5–R7', [], 'Week 11. Charbonnet IR stash only if you own Price.'),
  p('TreVeyon Henderson', 'RB', 'NE', 67, 5, 'R5–R7', [], 'CBS Sep 4: ankle, questionable Week 1. That is why Rhamondre moved ahead of him. Do not spend an early pick hoping the ankle is fine.'),

  // RB Tier 6–7
  p('Rhamondre Stevenson', 'RB', 'NE', 68, 6, 'R8–R10', [], 'Moved ahead of Henderson on some ADP boards after the ankle. Late-script R7 backup. Volume back, not a pass-catcher like Harvey.'),
  ...
  p('Tony Pollard', 'RB', 'TEN', 79, 6, 'R8–R10', [], 'Late-script R10 take. Titans lead work. FLEX, not a second Robust-RB brick.'),
  ...
  p('Chuba Hubbard', 'RB', 'CAR', 99, 7, 'R9–R12', [], 'Committee with Brooks. 4for4 liked Brooks more if Hubbard’s hamstring lingers. Depth only.'),
  ...
  p('Rashee Rice', 'WR', 'KC', 27, 3, 'R2–R3', [], 'Chiefs WR1 range. Healthy PPR target after the RB pair. Do not take him instead of the second running back in rounds 1–5.'),
  ...
  p('DeVonta Smith', 'WR', 'PHI', 34, 4, 'R3–R5', [], 'PPR slot. Early/mid R4 backup if you already have two RBs. Fine WR2 in 10-team.'),
  p('Garrett Wilson', 'WR', 'NYJ', 35, 4, 'R3–R5', [], 'Late R4 take.'),
  p('Tetairoa McMillan', 'WR', 'CAR', 37, 4, 'R3–R5', [], 'Panthers WR1 path. Early R4 alternative to Etienne if the last three-down back is gone.'),
  p('Zay Flowers', 'WR', 'BAL', 39, 4, 'R3–R5', [], 'Ravens WR1. Fantasy Points: team not concerned, practice soon for Week 1. Healthy WR after the RB pair.'),
  ...
  p('Terry McLaurin', 'WR', 'WAS', 55, 5, 'R5–R7', [], 'Late-script Waddle backup. Veteran WR2/FLEX. Not a reach over the smash list.'),
  p('Jameson Williams', 'WR', 'DET', 58, 5, 'R5–R7', [], 'Week 6 cluster. Early R6 take.'),
  p('Rome Odunze', 'WR', 'CHI', 59, 5, 'R5–R7', [], 'Bears WR. Early R6 backup to Jameson Williams. Depth, not a locked WR2.'),
  p('Luther Burden', 'WR', 'CHI', 66, 5, 'R5–R7', [], 'Back from a groin issue (For The Win Sep 5). Early R6 backup. Chicago WR committee — do not stack Odunze and Burden as core.'),
  ...
  p('DK Metcalf', 'WR', 'PIT', 76, 6, 'R7–R10', [], 'Dead-zone WR. Take Watson/Evans/Kraft here instead if they are up. Fine if those smash names are gone.'),
  ...
  p('Brian Thomas Jr.', 'WR', 'JAX', 109, 6, 'R7–R10', [], 'Mid R10 take if no QB yet as the WR. Ceiling WR who slid. FLEX, not over Lloyd if Lloyd is falling.'),
  ...
  p('Josh Downs', 'WR', 'IND', 131, 7, 'R10–R13', [], 'Cummings sleeper all summer, still around R10–11. Slot PPR. Bench lottery. Do not take over Godwin.'),
  p('Jayden Reed', 'WR', 'GB', 137, 7, 'R10–R13', [], 'Packers WR depth. Early R12 backup to Godwin. Do not add him if you already have Lloyd+Watson or Kraft as GB core.'),
  ...
  p('Colston Loveland', 'TE', 'CHI', 38, 2, 'R5–R7', [], 'Too early for no-premium. Mid script: not Warren TE in R5 applies here too. Wait for Kraft/Fannin.'),
  ...
  p('Dallas Goedert', 'TE', 'PHI', 94, 4, 'R11–R14', [], 'Streamer TE if Kraft/Fannin/LaPorta/Pitts/Kittle are gone. Fine R13+.'),
  ...
  p('Jason Myers', 'K', 'SEA', null, 1, 'R15–R16', [], 'Round 15 kicker. Week 11 bye. Not Aubrey.'),
  p('Cam Little', 'K', 'JAX', null, 1, 'R15–R16', [], 'Round 15 kicker. Late-script option. Not Aubrey.'),
  p('Jake Bates', 'K', 'DET', null, 1, 'R15–R16', [], 'Round 15 kicker. Week 6 with Gibbs/ARSB — do not add him if you already have two from that cluster.'),
